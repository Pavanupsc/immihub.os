      ...
      <div className="container">
        <div style={{ display: 'grid', gridTemplateColumns: '1.1fr 1fr', gap: 64, alignItems: 'center' }}>
          <div>
            ...
            <p className="lede">ImmiHub is designed to augment your practice - not replace it. We're partnering with leading immigration firms to shape the product.
    ...
    <section id="apply" className="section-alt" style={{ padding: '96px 0' }}>
      <div className="container-narrow">
        ...
        <div className="tiny" style={{ textAlign: 'center', marginTop: 28, maxWidth: 620, margin: '28px auto 0' }}>
          ...
          <a href="mailto:partners@getimmihub.com" style={{ color: PS.blueDeep, fontWeight: 500 }}>partners@immihub.ai </a>for details.
        </div>
      </div>
    </section>);
